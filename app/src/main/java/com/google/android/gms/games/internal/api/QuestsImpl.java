  ...
  implements Quests
{
  ...
  {
    paramGoogleApiClient.b(new AcceptImpl(paramGoogleApiClient, paramString)
    {
  ...
  {
    paramGoogleApiClient.b(new ClaimImpl(paramGoogleApiClient, paramString1)
    {
      protected void a(GamesClientImpl paramAnonymousGamesClientImpl)
      {
  ...
  {
    paramGoogleApiClient.a(new LoadsImpl(paramGoogleApiClient, paramArrayOfInt)
    {
      protected void a(GamesClientImpl paramAnonymousGamesClientImpl)
      {
  ...
  {
    paramGoogleApiClient.a(new LoadsImpl(paramGoogleApiClient, paramBoolean)
    {
      protected void a(GamesClientImpl paramAnonymousGamesClientImpl)
      {
    ...
    extends Games.BaseGamesApiMethodImpl<Quests.LoadQuestsResult>
  {
    ...
    public Quests.LoadQuestsResult aj(final Status paramStatus)
    {
      new Quests.LoadQuestsResult()
      {
        ...
        {
          return new QuestBuffer(DataHolder.av(paramStatus.getStatusCode()));
        }

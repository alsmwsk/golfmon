...
public final class PlusShare
{
  ...
  protected static boolean cg(String paramString)
  {
  ...
  public static Person createPerson(String paramString1, String paramString2)
  {
    ...
    return new pi(paramString2, paramString1, null, 0, null);
  }
  ...
  public static class Builder
  {
    ...
    public Builder(Activity paramActivity, PlusClient paramPlusClient)
    {
      ...
      {
        bool = true;
        jx.a(bool, "PlusClient must not be null.");
        jx.a(paramPlusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
        jx.a(paramPlusClient.os().cj("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
    ...
    public Builder addCallToAction(String paramString1, Uri paramUri, String paramString2)
    {
      ...
      {
        jx.b(bool, "Must provide a call to action URL");
        Bundle localBundle = new Bundle();
        if (!TextUtils.isEmpty(paramString1)) {
        ...
        if (!TextUtils.isEmpty(paramString2))
        {
          jx.a(PlusShare.cg(paramString2), "The specified deep-link ID was malformed.");
    ...
    public Builder addStream(Uri paramUri)
    {
      ...
      this.anF.add(localUri);
      this.anF.add(paramUri);
      return this;
    }
    ...
    {
      int i = 1;
      if ((this.anF != null) && (this.anF.size() > i))
      {
        int k = i;
        ...
        int n = i;
        label59:
        jx.a(n, "Call-to-action buttons are only available for URLs.");
        if ((bool2) && (!this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_URL"))) {
          break label308;
        }
        int i2 = i;
        label86:
        jx.a(i2, "The content URL is required for interactive posts.");
        ...
        label122:
        jx.a(i, "Must set content URL or content deep-link ID to use a call-to-action button.");
    ...
    public Builder setContentDeepLinkId(String paramString1, String paramString2, String paramString3, Uri paramUri)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        jx.b(bool, "The deepLinkId parameter is required.");

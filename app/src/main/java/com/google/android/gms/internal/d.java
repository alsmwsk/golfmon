    ...
    extends qq<a>
  {
    ...
    public boolean equals(Object paramObject)
    {
          ...
          do
          {
            ...
            do
            {
              ...
              do
              {
                ...
                bool3 = qu.equals(this.gw, locala.gw);
                bool2 = false;
              } while (!bool3);
              bool4 = qu.equals(this.gx, locala.gx);
              bool2 = false;
            } while (!bool4);
            bool5 = qu.equals(this.gy, locala.gy);
            bool2 = false;
          } while (!bool5);
          if (this.gz != null) {
            break label303;
      ...
      while (this.gA.equals(locala.gA))
      {
        ...
        boolean bool9 = qu.equals(this.gD, locala.gD);
        bool2 = false;
        if (!bool9) {
          break;
        }
        boolean bool10 = qu.equals(this.gE, locala.gE);
        bool2 = false;
        if (!bool10) {
          break;
        }
    ...
    public int hashCode()
    {
      ...
      {
        k = 0;
        int m = 31 * (31 * (31 * (31 * (k + j) + qu.hashCode(this.gw)) + qu.hashCode(this.gx)) + qu.hashCode(this.gy));
        if (this.gz != null) {
          break label200;
        }
        n = 0;
        ...
        i4 = i;
        i5 = 31 * (31 * (31 * (i4 + i3) + qu.hashCode(this.gD)) + qu.hashCode(this.gE));
        if (!this.gF) {
          break label232;
        }
      }
      ...
      throws IOException
    {
      for (;;)
      {
        ...
        case 8: 
          ...
          break;
        case 18: 
          this.gv = paramqo.readString();
          break;
        case 26: 
          int i15 = qz.b(paramqo, 26);
          if (this.gw == null) {}
          a[] arrayOfa4;
        ...
        case 42: 
          ...
          break;
        case 50: 
          this.gz = paramqo.readString();
          break;
        case 58: 
          this.gA = paramqo.readString();
          break;
        case 64: 
          this.gB = paramqo.rB();
          break;
        ...
        case 80: 
          ...
          break;
        case 82: 
          int m = paramqo.gS(paramqo.rG());
          int n = paramqo.getPosition();
          int i1 = 0;
          while (paramqo.rL() > 0) {
            switch (paramqo.rC())
            {

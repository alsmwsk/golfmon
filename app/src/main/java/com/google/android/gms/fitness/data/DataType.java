  ...
  implements SafeParcelable
{
  ...
  static
  {
    ...
    arrayOfField9[1] = Field.UA;
    Uq = new DataType("com.google.activity.edge", arrayOfField9);
    Field[] arrayOfField10 = new Field[3];
    arrayOfField10[0] = Field.UB;
    arrayOfField10[1] = Field.UC;
    arrayOfField10[2] = Field.UD;
    Ur = new DataType("com.google.accelerometer", arrayOfField10);
    ...
    arrayOfDataType2[0] = Ur;
    arrayOfDataType2[1] = Uq;
    ...
    arrayOfString[0] = Ur.getName();
    arrayOfString[1] = Uq.getName();
  ...
  {
    this(1, paramString, la.b(paramVarArgs));
  }
  
  private boolean a(DataType paramDataType)
  {
    return (this.mName.equals(paramDataType.mName)) && (this.Uv.equals(paramDataType.Uv));
  }
  
  public static List<DataType> getAggregatesForInput(DataType paramDataType)
  {
    List localList = (List)Us.get(paramDataType);
    if (localList == null) {
  ...
  public int indexOf(Field paramField)
  {
    if (this.Uv.contains(paramField)) {
      return this.Uv.indexOf(paramField);
    }

...
public class eh
{
  ...
  {
    this.ta = new a(paramContext, "google_inapp_purchase.db");
  }
  
  public static eh j(Context paramContext)
  {
    synchronized (mH)
    {
      if (tb == null) {
        tb = new eh(paramContext);
      }
      eh localeh = tb;
      return localeh;
    }
  ...
  public ef a(Cursor paramCursor)
  {
    if (paramCursor == null) {
      return null;
    }
    return new ef(paramCursor.getLong(0), paramCursor.getString(1), paramCursor.getString(2));
  }
  ...
  public void a(ef paramef)
  {
    ...
    arrayOfObject[1] = Long.valueOf(paramef.sT);
  ...
  public void b(ef paramef)
  {
    ...
    localContentValues.put("product_id", paramef.sV);
    localContentValues.put("developer_payload", paramef.sU);
    localContentValues.put("record_time", Long.valueOf(SystemClock.elapsedRealtime()));
    paramef.sT = localSQLiteDatabase.insert("InAppPurchase", null, localContentValues);
  ...
  {
    // Byte code:
    //   0: getstatic 40	com/google/android/gms/internal/eh:mH	Ljava/lang/Object;
    //   3: astore_1
    //   4: aload_1
    //   5: monitorenter
    //   6: aload_0
    //   7: invokevirtual 80	com/google/android/gms/internal/eh:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   10: astore_3
    //   11: aload_3
    //   12: ifnonnull +6 -> 18
    //   15: aload_1
    ...
    //   55: aload_0
    //   56: aload 5
    //   58: invokevirtual 150	com/google/android/gms/internal/eh:a	(Landroid/database/Cursor;)Lcom/google/android/gms/internal/ef;
    //   61: invokevirtual 152	com/google/android/gms/internal/eh:a	(Lcom/google/android/gms/internal/ef;)V
    //   64: aload 5
    //   66: ifnull +10 -> 76
    //   69: aload 5
    ...
    //   112: invokestatic 176	com/google/android/gms/internal/gr:W	(Ljava/lang/String;)V
    //   115: aload 5
    //   117: ifnull -41 -> 76
    //   120: aload 5
  ...
  /* Error */
  public java.util.List<ef> d(long paramLong)
  {
    // Byte code:
    //   0: getstatic 40	com/google/android/gms/internal/eh:mH	Ljava/lang/Object;
    //   3: astore_3
    ...
    //   25: areturn
    //   26: aload_0
    //   27: invokevirtual 80	com/google/android/gms/internal/eh:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   30: astore 6
    //   32: aload 6
    //   34: ifnonnull +8 -> 42
    //   37: aload_3
    ...
    //   78: aload_0
    //   79: aload 8
    //   81: invokevirtual 150	com/google/android/gms/internal/eh:a	(Landroid/database/Cursor;)Lcom/google/android/gms/internal/ef;
    ...
    //   149: invokestatic 176	com/google/android/gms/internal/gr:W	(Ljava/lang/String;)V
    //   152: aload 8
    //   154: ifnull -38 -> 116
    //   157: aload 8
  ...
  public int getRecordCount()
  {
    ...
    catch (SQLiteException localSQLiteException)
    {
      for (;;)
      {
        gr.W("Error getting record count" + localSQLiteException.getMessage());
        if (localCursor != null) {
          localCursor.close();
        }
      }
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.ta.getWritableDatabase();

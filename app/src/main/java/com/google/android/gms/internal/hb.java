...
public abstract interface hb
  extends IInterface
{
  public abstract void a(Map paramMap, long paramLong, String paramString, List<ha> paramList)
  ...
  public static abstract class a
    ...
    implements hb
  {
    public static hb D(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof hb))) {
        return (hb)localIInterface;
      }

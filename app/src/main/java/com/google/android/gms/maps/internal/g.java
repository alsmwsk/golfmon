  ...
  extends IInterface
{
    ...
    implements g
  {
    ...
    public static g ba(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      paramParcel1.enforceInterface("com.google.android.gms.maps.internal.IOnIndoorStateChangeListener");
      a(j.a.by(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements g
    {
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/maps/internal/g$a$a:le	Landroid/os/IBinder;
        //   36: iconst_2
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0

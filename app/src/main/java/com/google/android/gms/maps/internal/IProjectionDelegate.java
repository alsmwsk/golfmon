    ...
    implements IProjectionDelegate
  {
      ...
      implements IProjectionDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/maps/internal/IProjectionDelegate$a$a:le	Landroid/os/IBinder;
        //   36: iconst_1
        //   37: aload_2
        //   38: aload_3
        //   39: iconst_0
        ...
        //   59: iload 7
        //   61: ifeq +16 -> 77
        //   64: getstatic 59	com/google/android/gms/maps/model/LatLng:CREATOR	Lcom/google/android/gms/maps/model/i;
        //   67: aload_3
        //   68: invokevirtual 65	com/google/android/gms/maps/model/i:de	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/LatLng;
        //   71: astore 9
        //   73: aload 9
        //   75: astore 8
        //   77: aload_3
        ...
        throws RemoteException
      {
        ...
        //   36: ifeq +27 -> 63
        //   39: getstatic 87	com/google/android/gms/maps/model/VisibleRegion:CREATOR	Lcom/google/android/gms/maps/model/y;
        //   42: aload_2
        //   43: invokevirtual 93	com/google/android/gms/maps/model/y:do	(Landroid/os/Parcel;)Lcom/google/android/gms/maps/model/VisibleRegion;
        //   46: astore 6
        //   48: aload 6
        //   50: astore 5
        //   52: aload_2
        ...
        throws RemoteException
      {
        ...
        //   51: invokestatic 105	com/google/android/gms/dynamic/d$a:ap	(Landroid/os/IBinder;)Lcom/google/android/gms/dynamic/d;
        //   54: astore 6
        //   56: aload_3
        //   57: invokevirtual 68	android/os/Parcel:recycle	()V
        //   60: aload_2
        ...
        //   67: aload_2
        //   68: iconst_0
        //   69: invokevirtual 74	android/os/Parcel:writeInt	(I)V
        //   72: goto -43 -> 29
        //   75: astore 4
        //   77: aload_3
        //   78: invokevirtual 68	android/os/Parcel:recycle	()V

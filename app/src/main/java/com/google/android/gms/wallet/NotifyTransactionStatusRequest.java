  ...
  implements SafeParcelable
{
  ...
  public final class Builder
  {
    ...
    public NotifyTransactionStatusRequest build()
    {
      ...
      {
        int k = i;
        jx.b(k, "googleTransactionId is required");
      ...
      for (;;)
      {
        jx.b(i, "status is an unrecognized value");
    ...
    {
      NotifyTransactionStatusRequest.this.avL = paramString;
      return this;
    }
    
    public Builder setGoogleTransactionId(String paramString)
    {
      NotifyTransactionStatusRequest.this.auL = paramString;
      return this;
    }

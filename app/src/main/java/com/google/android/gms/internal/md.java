...
public abstract interface md
  extends IInterface
{
  public abstract void j(Status paramStatus)
    ...
    implements md
  {
    ...
    public static md az(IBinder paramIBinder)
    {
      ...
      implements md
    {
        ...
        throws RemoteException
      {
        ...
        //   24: aload_2
        //   25: iconst_0
        //   26: invokevirtual 43	com/google/android/gms/common/api/Status:writeToParcel	(Landroid/os/Parcel;I)V
        //   29: aload_0
        //   30: getfield 15	com/google/android/gms/internal/md$a$a:le	Landroid/os/IBinder;
        //   33: iconst_1
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0

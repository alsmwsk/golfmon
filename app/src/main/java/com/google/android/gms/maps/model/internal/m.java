  ...
  extends IInterface
{
  ...
  public static abstract class a
    ...
    implements m
  {
    public static m bB(IBinder paramIBinder)
    {
      ...
      throws RemoteException
    {
      ...
      case 19: 
        paramParcel1.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
        boolean bool1 = a(bB(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        int j = 0;
        if (bool1) {
          j = 1;
      ...
      implements m
    {
        ...
        throws RemoteException
      {
        ...
        //   32: aload_0
        //   33: getfield 15	com/google/android/gms/maps/model/internal/m$a$a:le	Landroid/os/IBinder;
        //   36: bipush 19
        //   38: aload_2
        //   39: aload_3
        //   40: iconst_0

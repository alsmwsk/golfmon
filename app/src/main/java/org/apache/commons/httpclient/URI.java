  ...
  implements Cloneable, Comparable, Serializable
{
    ...
    throws URIException
  {
    ...
    int i1;
    label119:
    for (char[] arrayOfChar3 = paramString.substring(0, j).toCharArray();; arrayOfChar3 = encode(paramString.substring(0, j), allowed_userinfo, str))
    {
    ...
    label331:
    for (char[] arrayOfChar1 = paramString.toString().toCharArray();; arrayOfChar1 = encode(paramString.toString(), allowed_reg_name, str))
    {
    ...
    throws URIException
  {
    ...
    label739:
    label754:
    for (char[] arrayOfChar2 = str1.substring(n + 1, i2).toCharArray();; arrayOfChar2 = encode(str1.substring(n + 1, i2), allowed_query, str3))
    {

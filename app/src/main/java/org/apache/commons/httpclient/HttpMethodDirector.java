...
class HttpMethodDirector
{
  ...
  private boolean processAuthenticationResponse(HttpMethod paramHttpMethod)
  {
    ...
    bool = processProxyAuthChallenge(paramHttpMethod);
    return bool;
    label83:
    return false;
  }
    ...
    throws RedirectException
  {
    ...
    //   0	500	0	this	HttpMethodDirector
    //   0	500	1	paramHttpMethod	HttpMethod
    //   9	47	2	localHeader	Header
    //   59	340	3	str	String
    //   143	307	4	localURI1	URI
    //   154	220	5	localURI2	URI
    //   495	1	6	localURIException1	URIException
    //   235	229	7	localURI3	URI
    //   490	1	8	localURIException2	URIException
    //   418	1	10	localURIException3	URIException
    //   380	1	11	localURIException4	URIException
    // Exception table:
    //   from	to	target	type
